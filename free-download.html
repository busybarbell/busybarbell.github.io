...
<body>
    <div class="container">
        <div class="callout">FREE WEIGHT LOSS RESOURCES</div>
        <div class="content">
            <h1 class="headline">Your Free Weight Loss Resources</h1>
            <p class="subheadline">While you don't currently qualify for our strategy session, here are some powerful resources to help you get started with your weight loss journey.</p>
            
            <div class="video-section">
                <div class="video-instruction">
                    <i class="fas fa-play-circle"></i>
                    <span>Watch This Important Message First</span>
                </div>
            ...
            <p class="subheadline">Here are the exact tools and resources I recommend to everyone who wants to lose weight effectively.</p>
            ...
            <h2 class="section-header">Recommended Apps</h2>
            <p class="subheadline">These two apps are all you need to track your progress and stay accountable.</p>
            
            <div class="resources-container">
                <div class="resource-card">
                    <img src="https://i.postimg.cc/dVfh9V2J/460x0w-1.webp" alt="Strong App" class="app-icon">
                    <h3 class="resource-title">Strong App</h3>
                    <p class="resource-description">The simplest workout tracker for logging your exercises, sets, reps, and weight. Perfect for beginners and experienced lifters alike.</p>
                    <p class="resource-description">Track your progress, see your personal records, and follow proven workout routines.</p>
                ...
                <div class="resource-card">
                    ...
                    <p class="resource-description">The most popular food tracking app with a database of millions of foods. Makes tracking your nutrition simple and effective.</p>
                    <p class="resource-description">Monitor your calories, protein, and other nutrients to ensure you're on track with your weight loss goals.</p>
                    <div class="store-buttons">
