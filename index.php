...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <meta name="description" content="Discover how to lose weight without giving up your favorite foods. Join our free strategy session to create a personalized weight loss plan.">
    ...
    <style>
        ...
        * {
        ...
        /* New CSS for the contact form fields */
        .form-row {
            display: flex;
            width: 100%;
...
<body>
    <div class="container">
        <div class="callout">ATTENTION: Overweight & Frustrated With Diets</div>
        <div class="content">
            <p class="subheadline">Tired of Failing at Weight Loss?</p>
            <h1 class="headline">Discover How To Lose Weight Without Giving Up Your Favorite Foods</h1>
            <p class="subheadline">Most people struggle with weight loss because they're following outdated advice. Watch this video to see what you're doing wrong and how to fix it.</p>

            <div class="video-section">
                <div class="video-instruction">
                    <i class="fas fa-play-circle"></i>
                    <span>Discover How In The Video Below</span>
                </div>
                ...
                <form class="contact-form" action="thank-you.php" method="post" id="qualificationForm">
                    ...
                    <div class="radio-options">
                        ...
                        <div class="radio-option">
                            ...
                            <label for="not_qualified">I'm researching free options</label>
                        </div>
        </div>
                    ...
                    <button type="submit" class="form-button" id="submitButton">See if I'm a Fit</button>
                </form>
